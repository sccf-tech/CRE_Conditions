...
month.POR=ggplot()+
  ...
  geom_line(data=subset(rf.dat.mon,CY==2021),
             aes(x=month,y=TRF.in,color="CY 2021"),linetype=2,size=1)+
...
```{r,warning=FALSE,fig.height=8.5,fig.width=7,echo=FALSE,fig.align="center",fig.cap="Caloosahatchee and tidal basin monthly rainfall calendar from 1979 to present."}
map.bar=plot_grid(
  map,month.POR,
  ncol=1,
  rel_heights = c(1,1.5))
