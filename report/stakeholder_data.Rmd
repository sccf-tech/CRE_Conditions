...
<div class="col-md-3">
WP Franklin **`r format(sum(S79.dat$Man.Prec,na.rm=T),nsmall=2)`"**
</div>
<div class="col-md-3">
Ortona **`r format(sum(S78.dat$Man.Prec,na.rm=T),nsmall=2)`"**
</div>
<div class="col-md-3">
Moore Haven **`r format(sum(S77.dat$Man.Prec,na.rm=T),nsmall=2)`"**
</div>
</div>
...
grid.raster(logo,x=0.05,y=0.05,just=c("left","bottom"),width=unit(1.25,"inches"))
```
