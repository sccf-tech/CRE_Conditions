...
dates2=c(date.fun(min(Q.dat.xtab$Date)-duration(90,'days')),date.fun(min(Q.dat.xtab$Date)-duration(1,'days')))
S79dat2=DBHYDRO_daily(dates2[1],dates2[2],"DJ237")
S79dat2$Q=S79dat2$Data.Value

S79dat2=rbind(S79dat2[,c("Date","Q")],subset(Q.dat,SITE2=="S79")[,c("Date","Q")])
...
for(i in 1:5){
  ...
  ylim.max=round(max.q+max.q*0.25,-2)
