...
<center>Average daily windspeed and direction and cyanobacteria algal
bloom coverage of Lake Okeechobee. Data from NOAA NCCOS HAB data
explorer.</center>
...
plot(subset(bgdat_30d.shp,toupper(toxinpresent)=="YES"),add=T,pch=21,bg="red",
     cex=ifelse(subset(bgdat_30d.shp,toupper(toxinpresent)=="YES")$microcystin.val>10,2,1),lwd=0.1)
}
box(lwd=1)
...
legend("center",legend=c("Toxin Present","Toxin Not Present >10 \u03BCg L\u207B\u00B9","Toxin Not Present","No Data"),
