...
# wx.dat=DBHYDRO_daily(wx.dates[1],wx.dates[2],dbkeys$DBKEY)
# 
# wx.dat=merge(wx.dat,dbkeys,'DBKEY')
# wx.dat$Date=date.fun(wx.dat$Date)
# 
# wx.dat.xtab=cast(wx.dat,Date~param,value="Data.Value",mean)
# wx.dat.xtab$WINDS.ms=wx.dat.xtab$WINDS*0.44704
