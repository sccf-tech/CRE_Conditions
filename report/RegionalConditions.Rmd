---
title: "Caloosahatchee Conditions Report"
output: 
  html_document: 
    toc: yes
    includes:
...
`r paste("Updated:",as.POSIXct(format(Sys.time(),format="%F %R",tz="EST")),format(as.POSIXct(format(Sys.time(),format="%F %R %Z",tz="EST")),'%Z'))`
