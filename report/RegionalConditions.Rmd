...
plot(subset(bgdat_30d.shp,toupper(toxinpresent)=="NO"),add=T,pch=21,bg="green",cex=1,lwd=0.1)
plot(subset(bgdat_30d.shp,toupper(toxinpresent)=="YES"),add=T,pch=21,bg="red",
     cex=ifelse(subset(bgdat_30d.shp,toupper(toxinpresent)=="YES")$microcystin.val>8,2,1),lwd=0.1)
}
box(lwd=1)
