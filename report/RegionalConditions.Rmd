...
if(i<3){
with(subset(recon.dat,SiteID==recon.sites[i]),pt_line(Date.EST,sal,1,"grey50",2,22,"grey50",cex=1,pt.col="black"))
with(subset(recon.dat,SiteID==recon.sites[i]),lines(Date.EST,MovingAvg.7d,lty=2,lwd=1.5,col="orange"))
legend("topleft",legend=c(paste0(station.label[i]," - SFWMD"),paste0(recon.lab[i]," - SCCF")),
       lty=c(NA,NA),lwd=c(0.1,0.1),col=c(colrmp,"grey50"),
       pch=c(21,22),pt.bg=c(colrmp,"grey50"),
       pt.cex=1,ncol=1,cex=0.75,bty="n",y.intersp=1,x.intersp=0.75,xpd=NA,xjust=0.5,yjust=0)
}else{
  legend("topleft",legend=c(paste0(station.label[i]," - SFWMD")),
       lty=c(NA,NA),lwd=c(0.1,0.1),col=c(colrmp,"grey50"),
       pch=c(21,22),pt.bg=c(colrmp,"grey50"),
       pt.cex=1,ncol=1,cex=0.75,bty="n",y.intersp=1,x.intersp=0.75,xpd=NA,xjust=0.5,yjust=0)
}
...
legend("topleft",legend=c(paste0(station.label[4]," - SFWMD"),paste0(recon.lab[4]," - SCCF")),
       lty=c(NA,NA),lwd=c(0.1,0.1),col=c(colrmp,"grey50"),
       pch=c(21,22),pt.bg=c(colrmp,"grey50"),
       pt.cex=1,ncol=1,cex=0.75,bty="n",y.intersp=1,x.intersp=0.75,xpd=NA,xjust=0.5,yjust=0)
