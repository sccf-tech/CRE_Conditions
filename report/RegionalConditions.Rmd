...
tm_shape(dat.shp)+tm_dots(col="Abundance",
                          size=0.03,
                          id="SampleDate_t",
                          popup.vars=c("HAB_ID","SampleDate_t","SAMPLE_DEPTH","Abundance","Source"),
                          palette =c("white","grey","dodgerblue1","orange","indianred1"),
                          group="FWC Redtide Data")
```
<font size=2><center>Current Red Tide Status of the most recent 8-days of sampling</center></font><font size=3 color="red"><center>Data are provisional and subject to change.</center></font>
