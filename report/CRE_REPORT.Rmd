...
unique(sal.dat$Flag)
# sal.dat[sal.dat$param=="SPC"&sal.dat$Data.Value<50,]<-NA
...
# test=data.frame(cast(subset(sal.dat,SITE=="CCORAL"),SITE+DATETIME+Date.EST~param,value="Data.Value",fun.aggregate = function(x)mean(x,na.rm=T)))
# test$Sal=with(test,SalinityCalc(SPC,WT))
