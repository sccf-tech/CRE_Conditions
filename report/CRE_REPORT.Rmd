...
par(family="serif",cex.axis=1,mar=c(2,2,1,1),oma=c(1.5,3,1,1));
...
```{r Cal_algae,echo=FALSE,fig.width=7,fig.height=5.5,fig.align='center'}
# 32315 relative fChl
...
abline(h=ymaj,v=xmaj,lty=3,col="grey")
with(cal.algae,pt_line(Date,X_FLOATING_32295,1,"tan3",1.5,21,"tan3",cex=1.25,pt.lwd=0.1))
...
for(i in 1:2){
plot(Sal~Date.EST,subset(Cal.Sal,SITE==CALSITES[i]),type="n",ylim=ylim.val,xlim=xlim.val,xaxt="n",xaxs="i",xlab=NA,yaxt="n",yaxs="i",ylab=NA,lwd=1.75,col=colrmp[1])
xx=c(xlim.val[1],xlim.val[1],xlim.val[2],xlim.val[2])
...
abline(h=seq(0,40,5))
with(subset(Cal.Sal,SITE==CALSITES[i]),pt_line(Date.EST,Sal,1,colrmp[i],2,21,colrmp[i],cex=2,pt.col=colrmp[i]))
...
plot(Sal~Date.EST,subset(Cal.Sal,SITE==CALSITES[3]),type="n",ylim=ylim.val,xlim=xlim.val,xaxt="n",xaxs="i",xlab=NA,yaxt="n",yaxs="i",ylab=NA,lwd=1.75,col=colrmp[3])
xx=c(xlim.val[1],xlim.val[1],xlim.val[2],xlim.val[2])
yy=c(0,5,5,0);polygon(x=xx,y=yy,col="peachpuff1")
yy2=c(35,40,40,35);polygon(x=xx,y=yy2,col="peachpuff1")
yy3=c(30,35,35,30);polygon(x=xx,y=yy3,col="khaki")
...
yy5=c(10,30,30,10);polygon(x=xx,y=yy5,col="darkseagreen2")
abline(h=seq(0,40,5))
with(subset(Cal.Sal,SITE==CALSITES[3]),pt_line(Date.EST,Sal,1,colrmp[3],2,21,colrmp[3],cex=2,pt.col=colrmp[3]))
axis_fun(1,xmaj,xmin,format(xmaj,"%m/%d"),cex.axis=1)
axis_fun(2,ymaj,ymin,ymaj,cex.axis=1)
mtext(side=3,station.label[3],line=1,cex=txt.cex*0.5)
box(lwd=lwd.val*1.5)

plot(Sal~Date.EST,subset(Cal.Sal,SITE==CALSITES[4]),type="n",ylim=ylim.val,xlim=xlim.val,xaxt="n",xaxs="i",xlab=NA,yaxt="n",yaxs="i",ylab=NA,lwd=2,col=colrmp[7])
xx=c(xlim.val[1],xlim.val[1],xlim.val[2],xlim.val[2])
...
abline(h=seq(0,40,5))
with(subset(Cal.Sal,SITE==CALSITES[4]),pt_line(Date.EST,Sal,1,colrmp[3],2,21,colrmp[3],cex=2,pt.col=colrmp[3]))
axis_fun(1,xmaj,xmin,format(xmaj,"%m/%d"),cex.axis=1)
axis_fun(2,ymaj,ymin,ymaj,cex.axis=1)
...
<font size=3><center>Daily average bottom salinity data for the last 14-days from sampling locations within the tidal Caloosahatchee River Estuary relative to oyster health (Sanibel, Shell Point and Cape Coral) and tape grass (<i>Vallisneria americana</i>) health (Ft. Myers only) conditions.</center></font>
<font size=4 color="red"><center>Data are provisional and subject to change.</center></font>
...
lwd.val=1
plot(MovingAvg.7d~Date.EST,Cal.Sal,type="n",ylim=ylim.val,xlim=xlim.val,xaxs="i",yaxs="i",yaxt="n",xaxt="n",ylab=NA,xlab=NA)
xx=c(xlim.val[1],xlim.val[1],xlim.val[2],xlim.val[2])
yy=c(0,5,5,0);polygon(x=xx,y=yy,col="peachpuff1")
yy2=c(35,40,40,35);polygon(x=xx,y=yy2,col="peachpuff1")
yy3=c(30,35,35,30);polygon(x=xx,y=yy3,col="khaki")
...
yy5=c(10,30,30,10);polygon(x=xx,y=yy5,col="darkseagreen2")
abline(h=seq(0,40,5))
for(i in 1:3){with(subset(Cal.Sal,SITE==CALSITES[i]),lines(Date.EST,MovingAvg.7d,lwd=3,col=cols[i]))}
...
```
<font size=3><center>Moving 7-day average salinities observed at the Cape Coral, Shell Point and Sanibel salinity monitoring stations relative to Oyster salinity health conditions.</center></font>
<font size=4 color="red"><center>Data are provisional and subject to change.</center></font>
