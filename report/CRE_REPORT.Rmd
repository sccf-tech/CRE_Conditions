...
```{rCal_algae,echo=FALSE,fig.width=7,fig.height=5,fig.align='center'}
# 32315 relative fChl
...
axis_fun(1,xmaj,xmin,NA);box(lwd=1)
mtext(side=2,line=2.5,"Relative Fluorescence Units\n(RFU) ")
...
abline(h=seq(0,40,5))
with(subset(Cal.Sal,SITE==CALSITES[4]),pt_line(Date.EST,Sal,1,colrmp[7],2,21,colrmp[7],cex=2,pt.col=colrmp[7]))
axis_fun(1,xmaj,xmin,format(xmaj,"%m/%d"),cex.axis=1)
axis_fun(2,ymaj,ymin,ymaj,cex.axis=1)
...
<font size=3><center>Daily average salinity data for the last 14-days from sampling locations within the tidal Caloosahatchee River Estuary relative to oyster health (Sanibel, Shell Point and Cape Coral) and tape grass (<i>Vallisneria americana</i>) health (Ft. Myers only) conditions.</center></font>
<font size=4 color="red"><center>Data are provisional and subject to change.</center></font>
